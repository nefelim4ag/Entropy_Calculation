...
entropy_calc: entropy_calc.o avg_mean.o shannon_f.o shannon_i.o log2_lshift16.o heuristic.o
	$(CC) $(CFLAGS) -o entropy_calc entropy_calc.o avg_mean.o shannon_f.o shannon_i.o log2_lshift16.o heuristic.o
